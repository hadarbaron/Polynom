/**
 * Test for Polynom and Monom Class
...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(p1.root(-2.0, 0, 0.0001));
		System.out.println(p1.root(0, 3, 0.0001));
		System.out.println(p1.root(3, 6, 0.0001));
		System.out.println("######test1######");
		
		test1();
		System.out.println("\n\n######test2######\n");
		test2();
		Polynom_able p6=new Polynom ("5x-6");
		Polynom_able p7=new Polynom ("5x-6");
		System.out.println("shira"+p7.equals(p6));
		p6=new Polynom ("5x-6");
